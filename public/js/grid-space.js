...
;(function ( $, window, document, undefined ) {
    ...
    $.extend(MGSpace.prototype, {
        ...
        openRow: function (element) {
            ...
            show_grid($(element).find('.show_grid').attr('data-id'));
        ...
        openTarget: function (element) {
                ...
                itemId = $(element).find('.show_grid').attr('data-id'),
                // itemId = $(element).attr('data-id'),
                $itemTarget = $(_.options.target+'[data-section="' + itemSection + '"][data-video="' + itemId + '"]', _.$mgSpace);
        ...
        resizeSpace: function (element) {
            var _ = this,
                ...
                itemSection = $(element).attr('data-section'),
                itemPosition = $(element).position(),
                $itemTarget = $(_.options.target+'[data-section="' + itemSection + '"][data-video="' + itemId + '"]'),
