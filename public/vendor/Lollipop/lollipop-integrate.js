(function() {
   ...
   var Lollipop = function() {
      var instance = {
         getParams: function() {return _lollipop.params;},
         setOptions: function(options) {_lollipop.setOptions(options);return this;},
         close: function() {_lollipop.close();},
         open: function(options, image) {_lollipop.open(options); this.image = image;},
         save: function(data) {_lollipop.params.onSave(data);},
         image: undefined
      }
      return instance;
   }
   var _lollipop = {
      ...
      open: function(options) {
         ...
         if (document.querySelector("#lollipop-editor-container") == undefined) {
            ...
            link.rel = "stylesheet";
            link.href = _lollipop.getPath() + "assets/css/integrate.css";
      ...
      getFinalImage: function(url) {
         ...
         var request = _lollipop.ajax(_lollipop.getPath() + 'getImage.php', 'url=' + _lollipop.absoluteUrl(url));
